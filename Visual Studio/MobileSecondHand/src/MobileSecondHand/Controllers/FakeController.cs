...
namespace MobileSecondHand.Controllers {
    ...
    public class FakeController : Controller
    {
		...
		public void CreateFakeAdvertisements() {
			...
			var avdertisementPhoto2 = new DB.Models.Advertisement.AdvertisementPhoto { AdvertisementItem = advertisement, IsMainPhoto = true, PhotoPath = "./wwwroot/images/advertisementItem/foty/spodnie.jpg" };
			advertisement2.AdvertisementPhotos.Add(avdertisementPhoto2);
			advertisement2.AdvertisementPhotos.Add(new DB.Models.Advertisement.AdvertisementPhoto { AdvertisementItem = advertisement, IsMainPhoto = false, PhotoPath = "./wwwroot/images/advertisementItem/foty/spodnie.jpg" });
			...
			var avdertisementPhoto3 = new DB.Models.Advertisement.AdvertisementPhoto { AdvertisementItem = advertisement, IsMainPhoto = true, PhotoPath = "./wwwroot/images/advertisementItem/foty/sukienka 2.jpg" };
			...
			advertisement5.AdvertisementPhotos.Add(new DB.Models.Advertisement.AdvertisementPhoto { AdvertisementItem = advertisement, IsMainPhoto = false, PhotoPath = "./wwwroot/images/advertisementItem/foty/sweter.jpg" });
