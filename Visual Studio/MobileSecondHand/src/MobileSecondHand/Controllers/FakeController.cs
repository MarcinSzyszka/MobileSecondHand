...
namespace MobileSecondHand.Controllers
{
	...
	public class FakeController : Controller
	{
		...
		private void AddFiveAdvertisements()
		{
			...
			var advertisement2 = new DB.Models.Advertisement.AdvertisementItem { CategoryId = 1, IsActive = true, ExpirationDate = DateTime.Now.AddDays(7), Title = "Spodnie dżinsowe, rozm 44", Price = 55, Latitude = 52.0137376, Longitude = 20.8530181, User = fakeUser };
			...
			var advertisement3 = new DB.Models.Advertisement.AdvertisementItem { CategoryId = 1, IsActive = true, ExpirationDate = DateTime.Now.AddDays(7), Title = "Sukienka wieczorowa, rozm 38, TANIO", Price = 99, Latitude = 52.0417376, Longitude = 20.8540181, User = fakeUser };
			...
			var advertisement4 = new DB.Models.Advertisement.AdvertisementItem { CategoryId = 1, IsActive = true, ExpirationDate = DateTime.Now.AddDays(7), Title = "Sukienka \"mała czarna\", rozm 38, nowa!", Price = 69, Latitude = 52.0117376, Longitude = 20.8640181, User = fakeUser };
			...
			var advertisement5 = new DB.Models.Advertisement.AdvertisementItem { CategoryId = 1, IsActive = true, ExpirationDate = DateTime.Now.AddDays(7), Title = "Ciepły sweter rozm L. Jak nowy, tylko przymierzony!", Price = 49, Latitude = 52.0917376, Longitude = 20.8540181, User = fakeUser };
