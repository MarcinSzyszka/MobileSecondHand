...
namespace MobileSecondHand.Controllers {
    ...
    public class FakeController : Controller
    {
		...
		public void CreateFakeAdvertisements() {
			...
			var advertisement = new DB.Models.Advertisement.AdvertisementItem { IsActive = true, ExpirationDate = DateTime.Now.AddDays(7), Title = "Spodnie klasyczne, materiałowe, rozm 40", Price = 40, Latitude = 52.0217376, Longitude = 20.8240181, User = fakeUser };
			...
			var advertisement2 = new DB.Models.Advertisement.AdvertisementItem { IsActive = true, ExpirationDate = DateTime.Now.AddDays(7), Title = "Spodnie dżinsowe, rozm 44", Price = 55, Latitude = 52.0137376, Longitude = 20.8530181, User = fakeUser };
			var avdertisementPhoto2 = new DB.Models.Advertisement.AdvertisementPhoto { AdvertisementItem = advertisement2, IsMainPhoto = true, PhotoPath = "./wwwroot/images/advertisementItem/foty/spodniemin.jpg" };
			...
			var advertisement3 = new DB.Models.Advertisement.AdvertisementItem { IsActive = true, ExpirationDate = DateTime.Now.AddDays(7), Title = "Sukienka wieczorowa, rozm 38, TANIO", Price = 99, Latitude = 52.0417376, Longitude = 20.8540181, User = fakeUser };
			var avdertisementPhoto3 = new DB.Models.Advertisement.AdvertisementPhoto { AdvertisementItem = advertisement3, IsMainPhoto = true, PhotoPath = "./wwwroot/images/advertisementItem/foty/sukienka 2min.jpg" };
			...
			var advertisement4 = new DB.Models.Advertisement.AdvertisementItem { IsActive = true, ExpirationDate = DateTime.Now.AddDays(7), Title = "Sukienka \"mała czarna\", rozm 38, nowa!", Price = 69, Latitude = 52.0117376, Longitude = 20.8640181, User = fakeUser };
			var avdertisementPhoto4 = new DB.Models.Advertisement.AdvertisementPhoto { AdvertisementItem = advertisement4, IsMainPhoto = true, PhotoPath = "./wwwroot/images/advertisementItem/foty/sukienkamin.png" };
			...
			var advertisement5 = new DB.Models.Advertisement.AdvertisementItem { IsActive = true, ExpirationDate = DateTime.Now.AddDays(7), Title = "Ciepły sweter rozm L. Jak nowy, tylko przymierzony!", Price = 49, Latitude = 52.0917376, Longitude = 20.8540181, User = fakeUser };
			var avdertisementPhoto5 = new DB.Models.Advertisement.AdvertisementPhoto { AdvertisementItem = advertisement5, IsMainPhoto = true, PhotoPath = "./wwwroot/images/advertisementItem/foty/swetermin.jpg" };
